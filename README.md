...
Реализованный проект представляет собой веб-сервис, состоящий из FastAPI-сервера и Streamlit-приложения
для взаимодействия с моделями машинного обучения для классификации изображений автомобилей.

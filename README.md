...
Реализованный проект представляет собой веб-сервис, состоящий из FastAPI-сервера, Streamlit-приложения
и Telegram бота с отдельным FastAPI-сервером для взаимодействия с моделями машинного обучения
для классификации изображений автомобилей.
